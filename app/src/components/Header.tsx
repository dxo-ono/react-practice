  ...
  return (
      ...
      <div className="max-w-6xl mx-auto px-6 py-3 flex justify-between items-center">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="max-[390px]:hidden">
            <div
              className="font-zen text-[14px] font-normal leading-[1.6] tracking-[0.7px]"
              css={logoTextStyle}
    ...
    >
      ...
      <div className="relative w-[70px] h-[70px]">
        ...
        <mask id="mask0_10915_10721" mask-type="alpha" maskUnits="userSpaceOnUse" x="21" y="21" width="28" height="28">
      ...
      <div className="flex flex-col items-center px-[21px] gap-[6px]">
        <div className="w-[28px] h-[2px]" style={{ backgroundColor: '#9D9D9D' }}/>
        <div className="w-[28px] h-[2px]" style={{ backgroundColor: '#9D9D9D' }}/>
        <div className="w-[28px] h-[2px]" style={{ backgroundColor: '#9D9D9D' }}/>
      </div>
    )}
      ...
      {menuOpen && (
        ...
        >
              ...
              <div className="w-[300px] flex py-[24px] justify-center items-center"
              style={{borderBottom: "1px solid var(--style-object-silver, #C4C4C4)"}}>
                <a
                  href="ページリンク"
