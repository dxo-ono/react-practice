    ...
    >
      ...
      {isMobile ? (
        <>
          ...
          {menuOpen && (
            <nav
              className="absolute w-[390px] h-[784px] flex flex-col items-center text-base top-0 right-0 px-[20px] bg-[var(--style-background-white)]"
                style={{minWidth: "160px", zIndex: 100, boxShadow: "0px 0px 20px 0px rgba(0, 0, 0, 0.20)"}}
            >
              <div className="flex h-[70px] md:h-[80px] pl-[20px] justify-end items-center gap-[261px] flex-shrink-0"
                onClick={() => setMenuOpen(!menuOpen)}
                role="button"
                aria-label="Toggle menu"
                tabIndex={0}
              ...
              <div className="flex flex-col gap-[60px] my-auto">
                ...
                <div className="w-[300px] mx-auto flex flex-col md:flex-row md:w-auto md:h-auto md:p-0 justify-center items-center pb-[78.941175px]">
