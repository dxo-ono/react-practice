...
//   div {
//     height: 3px;
//     background: var(--Style-Text-Black, #434343);
//     border-radius: 2px;
//   }
// `;
...
//           <>
//             {/* ハンバーガーボタン */}
//             <div css={hamburgerStyle} onClick={() => setMenuOpen(!menuOpen)} role="button" aria-label="Toggle menu" tabIndex={0}>
//               <div />
//               <div />
//               <div />
//             </div>
...
//             {menuOpen && (
//               <nav
//                 className="absolute top-full right-0 mt-2 bg-white shadow-lg rounded-md p-4 flex flex-col gap-4"
//                 style={{ minWidth: "160px", zIndex: 100 }}
//               >
//                 <a
//                   href="ページリンク"
//                   className="font-zen text-[16px] font-normal leading-[1.6] tracking-[0.8px]"
//                   style={{ color: "var(--Style-Text-Black, #434343)" }}
...
//                 <a
//                   href="ページリンク"
//                   className="font-zen px-6 py-2 rounded-full text-[16px] font-medium text-center bg-gradient-to-r"
//                   css={buttonStyle}
//                   onClick={() => setMenuOpen(false)}
//                 >
//                   採用エントリー
