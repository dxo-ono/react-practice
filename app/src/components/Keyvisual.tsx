...
const catchBorderStyleY = css`
      background: var(--Gradient-Vivid-y, linear-gradient(0deg, var(--Master-Sub-Green, #AADCB9) 0%, var(--Master-Sub-Blue, #82BEF0) 50%, var(--Master-Sub-Purple, #D2A5EB) 100%));
      border-radius: 1px;
`;
...
const KeyVisual: React.FC = () => {
  ...
  <div
    ...
    <div className="flex flex-col md:flex-row justify-center items-center text-center gap-[12px] md:gap-[80px]">
      {/* キャッチコピー */}
        {/* 左:タイトル catchMain */}
          <div  className="font-zen text-3xl md:text-4xl font-bold" css={catchMainStyle}>
            DXO Blog
          </div>
        {/* キャッチコピー間グラデ線・縦横切り替え */}
        <div className="w-[62px] h-[2px] md:w-[2px] md:h-[62px]"
        css={isMediumUp ? catchBorderStyleY : catchBorderStyle}
        ></div>
        {/* 右:サブ catchSub */}
            <div className="font-zen text-base md:text-lg text-left" css={catchSubStyle}>
