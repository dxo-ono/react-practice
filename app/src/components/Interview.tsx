...
const Interview: React.FC = () => {
  ...
  // 総ページ数
  const totalPages = Math.ceil(interviewData.length / ITEMS_PER_PAGE);
  // 現在ページの開始・終了
  const startIdx = (currentPage - 1) * ITEMS_PER_PAGE;
  const endIdx = startIdx + ITEMS_PER_PAGE;
  // 現在ページに表示する記事
  const currentArticles = interviewData.slice(startIdx, endIdx);
        ...
        {currentArticles.map((interview) => (
          ...
          >
            ...
            <div className="flex flex-col items-start h-[220px] p-[20px] gap-[10px] self-stretch">
              {/* タイトル */}
              <h3 className="line-clamp-3 text-to-hover">{interview.title}</h3>
              {/* 内容 */}
              <p className="line-clamp-2 text-to-hover">{interview.description}</p>
              {/* 日付・発信者まとめ */}
              <div className="flex justify-between items-center self-stretch">
                ...
                <div className="flex pt-[4px] justify-center items-center gap-[4px] text-to-hover">
                    ...
                    <span className="font-zen text-sm font-regular leading-tall tracking-[0.7px] text-[var(--style-text-gray)] text-to-hover">{interview.date}</span>
                  </div>
                  {/* 発信者・svg */}
                  <div className="flex pt-[4px] justify-center items-center gap-[4px] text-to-hover">
                    ...
                    <span className="font-zen text-sm font-regular leading-tall tracking-[0.7px] text-[var(--style-text-gray)] text-to-hover">{interview.author}</span>
                  </div>
              </div>
            </div>
          </div>
