        ...
        {currentArticles.map((interview) => (
          ...
          >
            ...
            <div className="flex flex-col items-start h-[220px] p-[20px] gap-[10px] self-stretch">
              {/* タイトル */}
              <h3 className="line-clamp-3">{interview.title}</h3>
              {/* 内容 */}
              <p className="line-clamp-2">{interview.description}</p>
              {/* 日付・発信者まとめ */}
...
//   return (
//     <div className="max-w-[1280px] flex flex-col justify-center items-center m-w-[1280px] pb-[80px] gap-[60px]">
//         <div className="flex flex-col items-center self-stretch gap-[8px]">
//             <div className="flex justify-center items-center font-zen not-italic self-stretch font-md text-md leading-[1.6] tracking-[0.05em] pt-[60px] lg:pt-[80px]">
//               インタビュー
//             </div>
...
//         <div className="flex w-[350px] pb-[80px] flex-col justify-center items-center rounded-[28px]">
//             （仮）内容  （仮）内容  （仮）内容  （仮）内容  （仮）内容  （仮）内容  （仮）内容  （仮）内容<br />
//             （仮）内容  （仮）内容  （仮）内容  （仮）内容  （仮）内容  （仮）内容  （仮）内容  （仮）内容<br />
//             （仮）内容  （仮）内容  （仮）内容  （仮）内容  （仮）内容  （仮）内容  （仮）内容  （仮）内容<br />
//             （仮）内容  （仮）内容  （仮）内容  （仮）内容  （仮）内容  （仮）内容  （仮）内容  （仮）内容<br />
//             （仮）内容  （仮）内容  （仮）内容  （仮）内容  （仮）内容  （仮）内容  （仮）内容  （仮）内容<br />
