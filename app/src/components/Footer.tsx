...
const borderTopStyle = css`
  ...
  /* md〜xl（768px〜1279px）w-full */
  @media (min-width: 768px) and (max-width: 1279px) {
    width: 100%;
  }

  /* lg以上は border-top をなくし border-left に変更 */
...
<div
  className="flex flex-col xl:flex-row items-center xl:items-start justify-between w-full gap-[40px] pt-[40px] px-[40px] lg:gap-auto xl:px-[80px] pb-[40px] xl:pb-[82px]"
  css={backgroundStyle}
>
    {/* DXO ～ 旧テックブログはこちらからまでラッパー */}
    <div className="md:flex items-start x-full md:gap-[60px]">
      {/* カラム1: DXO説明とSNS */}
      <div className="flex flex-col items-center md:items-start gap-[40px]">
        {/* タイトル・説明 */}
        <div className="flex flex-col items-center md:items-start gap-[8px] self-stretch">
          <div className="text-md font-md leading-tall tracking-[1.2px] text-[var(--style-text-black)]">
            DXO Blog
          </div>
          <div className="text-sm text-[var(--style-text-black)] md:whitespace-nowrap">
            DXOの社員や文化、最新のお知らせをお届けするブログ。
          </div>
        </div>

        {/* SNSアイコン */}
        <div className="flex justify-start items-center gap-[12px] pb-[40px] md:pb-0">
          <Link to="/">
            <div
          ...
          {/* Category・Active */}
          <div className="flex flex-col md:flex-row gap-[40px] lg:gap-[60px]">
            <div className="flex py-[2px] px-0 flex-col items-start gap-[16px]">
      ...
      {/* Contact・ボーダー */}
      <div
        className="flex flex-col md:items-center xl:items-start gap-[16px] pt-[20px] xl:pt-0 xl:pl-[32px]"
        css={borderTopStyle}
        >
        <div className="text-base font-md leading-tall tracking-[0.8px] text-[var(--style-text-gray)]">
          Contact
        ...
        <div className="flex flex-col gap-[12px]">
          ...
          <div className="flex text-sm items-center gap-[6px] font-regular leading-tall tracking-[0.7px] text-[var(--style-text-black)]" css={borderBottomStyle}>
...
{/* コピーライト */}
<div className="w-full pt-[20px] pb-[40px] flex items-center justify-center text-xs text-[var(--style-text-gray)]" css={responsiveCopyStyle}>
